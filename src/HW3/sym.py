...
class SYM:
    ...
    def dist(self, s1, s2):
        """
            Returns the distance between the two symbols

            Parameters
            ----------
            s1 : flaot : The first symbol from which distance must be calculated
            s2 : float : The second symbol from which distance must be calculated

            Returns
            ---------
            float : check if s1 = s2
